...
// 1. ຟັງຊັນສະແດງລາຍການສິນຄ້າໃນໜ້າຫຼັກ
...
// 3. ຟັງຊັນລຶບສິນຄ້າອອກຈາກກະຕ່າທັງໝົດ
function removeFromCart(id) {
    cart = cart.filter(item => item.id !== id);
    updateCart();
}

// 4. ຟັງຊັນອັບເດດຂໍ້ມູນ ແລະ ຄຳນວນລາຄາໃນກະຕ່າ
function updateCart() {
...
// 5. ຟັງຊັນໃຊ້ລະຫັດສ່ວນຫຼຸດ купон
...
// 6. ຟັງຊັນຢືນຢັນການຊື້ ແລະ ເກັບຂໍ້ມູນໄປໜ້າໃບບິນ (Receipt)
function handleCheckout(event) {
    if (event) event.preventDefault();
    
    if (cart.length === 0) {
        alert('ກະລຸນາເລືອກສິນຄ້າລົງກະຕ່າg່ອນ!');
        return;
    }
    ...
    const customerName = customerNameInput && customerNameInput.value.trim() !== "" ? customerNameInput.value : "ລູກຄ້າທົ່ວໄປ";
    const customerTel = customerTelInput && customerTelInput.value.trim() !== "" ? customerTelInput.value : "ບໍ່ລະບຸ";
...
// 7. ຟັງຊັນເພີ່ມຈຳນວນສິນຄ້າໃນກະຕ່າ
...
// 8. ຟັງຊັນຫຼຸດຈຳນວນສິນຄ້າໃນກະຕ່າ
...
// 9. ຟັງຊັນປ່ຽນ Dark Mode / Light Mode
